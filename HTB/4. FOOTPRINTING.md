...
```
Captainsparrow@htb[/htb]$ git clone https://github.com/cddmp/enum4linux-ng.git
Captainsparrow@htb[/htb]$ cd enum4linux-ng
Captainsparrow@htb[/htb]$ pip3 install -r requirements.txt
```
```