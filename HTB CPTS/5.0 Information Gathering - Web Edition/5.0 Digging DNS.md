...
If you just want the answer to the question, without any of the other information, you can query `dig` using `+short`:
        ...
        shellsession
`Captainsparrow@htb[/htb]$ dig +short hackthebox.com 104.18.20.126 104.18.21.126`
