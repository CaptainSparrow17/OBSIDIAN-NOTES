...
```shell
Captainsparrow@htb[/htb]$ cat /etc/snmp/snmpd.conf | grep -v "#" | sed -r '/^\s*$/d'
``` 
![](../../Attachements/Pasted%20image%2020260702195323.png)
...
snmpwalk -v2c -r 2 -t 5 -c public 10.129.42.195 => use this if times out
```
![](../../Attachements/Pasted%20image%2020260713103602.png)
imp:: If you check snmp walk some time you will get login cred like that.
#### snmp-check
```shell
snmp-check 10.129.75.6
```
![](../../Attachements/Pasted%20image%2020260702204258.png)
...
onesixtyone -c /usr/share/wordlists/seclists/Discovery/SNMP/snmp.txt 10.129.42.195
```

![](../../Attachements/Pasted%20image%2020260702205021.png)
...
```shell
Captainsparrow@htb[/htb]$ sudo apt install braa 
Captainsparrow@htb[/htb]$ braa <community string>@<IP>:.1.3.6.* # Syntax 
Captainsparrow@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
```
![](../../Attachements/Pasted%20image%2020260702205152.png)
some time bra gives user cred::
![](../../Attachements/Pasted%20image%2020260713105411.png)
user=tom
