...
#### Loging ssh using id_rsa
1)check id_rsa file permission
```shell
chmod 600 id_rsa
```
2)Login in using id_rsa
```shell
ssh -i id_rsa ceil@10.129.84.204
```
![](../../Attachements/Pasted%20image%2020260708105516.png)
Bazinga, we are in. No password needed
...
cat /etc/hosts.equiv
```
![](../../Attachements/Pasted%20image%2020260705110623.png)
...
```
![](../../Attachements/Pasted%20image%2020260705110729.png)
...
cat .rhosts
```
![](../../Attachements/Pasted%20image%2020260705111504.png)
...
```
![](../../Attachements/Pasted%20image%2020260705111718.png)
...
rwho
```
![](../../Attachements/Pasted%20image%2020260705111802.png)
