...
sudo smtp-user-enum -M VRFY -u robin -t 10.129.42.195 -w 10  => This worked because wait time for some user were high.
```
#### IMP Remember that some SMTP servers have higher response times. 
	Thus -w 10
#### SMTP user eum Metasploit Module
scanner/smtp/smtp_enum
![](../../Attachements/Pasted%20image%2020260630093610.png)
