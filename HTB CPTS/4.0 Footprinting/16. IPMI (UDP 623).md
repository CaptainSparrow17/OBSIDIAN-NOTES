...
This gonna give the hash
![](../../Attachements/Pasted%20image%2020260704154214.png)

### Crack hash using hashcat
1)1st save hash to a file
![](../../Attachements/Pasted%20image%2020260704154257.png)
in this task saved hash like above
when used admin:ajkgdsjahgdahdga=> error
when used ahjgsdahjgd:asghahjd => no error( removed admin:)
2)run hashcst command
```shell
hashcat -m 7300 ipmihash.txt /usr/share/wordlists/rockyou.txt --show
hashcat -m 7300 ipmihash.txt /usr/share/wordlists/rockyou.txt =>show option sometime needed, sometime no needed
```
![](../../Attachements/Pasted%20image%2020260704154436.png)