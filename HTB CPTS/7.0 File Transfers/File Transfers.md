...
```powershell
PS C:\htb> [Convert]::ToBase64String((Get-Content -path "C:\Windows\system32\drivers\etc\hosts" -Encoding byte)) => To encode

PS C:\htb> Get-FileHash "C:\Windows\system32\drivers\etc\hosts" -Algorithm MD5 | select Hash => To generate Hash
```
![](../../Attachements/Pasted%20image%2020260726134943.png)
...
```shell
Captainsparrow@htb[/htb]$ md5sum hosts
```
...
```
![](../../Attachements/Pasted%20image%2020260726135856.png)
