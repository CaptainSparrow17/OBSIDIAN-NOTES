...
![[Pasted image 20250104120939.png]]
##### filetype: Search for specific filetype
![[Pasted image 20250104121013.png]]
##### dash - : exclude 
![[Pasted image 20250104122044.png]]
...
![[Pasted image 20250104122354.png]]
##### intex: 
...
![[Pasted image 20250104124010.png]]
...
![[Pasted image 20250104125214.png]]
...
![[Pasted image 20250104130045.png]]
...
![[Pasted image 20250104135020.png]]
...
```
![[Pasted image 20250105144709.png]]
...
```
![[Pasted image 20250105150129.png]]
##### xfreerdp | xfreerdp3
```bash
xfreerdp3 /u:student /p:lab /v:192.165.196.152
```
![[Pasted image 20250106110512.png]]
...
-u                     UDP Scan
![[Pasted image 20250106113654.png]]
UDP Scan
![[Pasted image 20250106114611.png]]
...
![[Pasted image 20250107123124.png]]

###### Network Sweep (`-sn`)
```bash
nmap -sn 192.168.50.1-253
```
![[Pasted image 20250107123237.png]]
...
```
![[Pasted image 20250107123346.png]]
...
```
![[Pasted image 20250107123533.png]]
...
```
![[Pasted image 20250107204251.png]]
SMB enum windows
```cmd.exe
net view \\dc01 /all
```
...
![[Pasted image 20250107205529.png]]
...
^C
```
![[Pasted image 20250107211707.png]]
Automate this::
```bash
#!/usr/bin/python
...
![[Pasted image 20250108120828.png]]
##### snmp-check
```bash
snmp-check 1.1.1.1
```
![[Pasted image 20250108122825.png]]
